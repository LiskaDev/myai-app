...
- **打字机叙事** — 流式 SSE + 标点节奏感停顿，沉浸式小说阅读体验
- **行动建议** — AI 每轮生成 3 条上下文相关的行动选项 + 🎲 随机行动
- **书籍设置** — 叙事风格（武侠/仙侠/现代/末世/西幻）、难度（轻松/普通/硬核）、世界书条目编辑
- **自动存档** — AI 回复完成后自动保存当前状态和对话历史
- **事件标签** — 金色情报 / 红色危险 / 绿色获得 / 紫色神秘，视觉化叙事反馈
