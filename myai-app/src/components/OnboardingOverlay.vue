...
const steps = [
  {
    icon: '🔑',
    title: '先配置 API Key',
    desc: '右上角点 ⚙ 设置，填入你的 API Key（支持 DeepSeek、OpenAI 等）。没有 Key 就无法与 AI 对话。',
    tip: 'API Key 只存在你本地浏览器，不会上传到任何服务器',
  },
  {
    icon: '🎭',
    title: '选一个角色开始',
  ...
  },
  {
    icon: '🌏',
    title: '小说冒险模式',
    desc: '点顶部「🌏 世界」Tab，导入一本 TXT 小说，AI 会自动提取世界观，生成一个可以沉浸闯关的互动故事。',
    tip: '支持多存档，随时存读，世界书条目可在书籍设置里手动补充',
  },
];
