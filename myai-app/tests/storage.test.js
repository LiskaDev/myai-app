...
describe('DEFAULT_GLOBAL_SETTINGS', () => {
    it('应该包含必要的默认值', () => {
        ...
        expect(DEFAULT_GLOBAL_SETTINGS.model).toBe('deepseek-flash');
        ...
        expect(DEFAULT_GLOBAL_SETTINGS.readingDensity).toBe('standard');
        expect(DEFAULT_GLOBAL_SETTINGS.motionLevel).toBe('soft');
    });
